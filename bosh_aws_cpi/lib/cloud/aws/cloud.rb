  ...
  class Cloud < Bosh::Cloud
    ...
    def initialize(options)
      ...
      aws_params = {
          ...
          :ec2_service_path => @aws_properties["service_path"] || "/services/Eucalyptus",
          :ec2_port => @aws_properties["ec2_port"] || 8773,
          :use_ssl => false,
          :logger => @aws_logger
      }
      ...
      #Modify by Nathan for eucalyptus
      @region = AWS::EC2::Region.new('eucalyptus',
    ...
    def attach_ebs_volume(instance, volume)
      ...
      ("c".."p").each do |char| # f..p is what console suggests
